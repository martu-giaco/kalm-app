<x-layout :title="$brand->name">
    <section class="pt-10 bg-white dark:bg-[#2A4043] vh rounded-t-3xl">
            ...
            <div class="flex-1 min-w-0">
                <div class="flex items-center justify-between gap-3">
                    <div class="flex w-full justify-between items-end">
                        <h1 class="text-xl font-semibold text-[#2A4043] dark:text-[#CCE2E5] truncate">{{ $brand->name }}</h1>
                    </div>
                </div>
                    ...
                    @php
                        $total = method_exists($products, 'total')
                            ...
                            : (is_countable($products)
                                ...
                                : $products->count() ?? 0);
                    @endphp
                        <h2 class="text-lg font-bold text-[#306067] dark:text-[#E9E5E3] mb-1">
                            Productos
                        </h2>
                    {{-- boton filtros --}}
                    <button onclick="filters_modal.showModal()" type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                            class="fill-[#306067] dark:fill-[#E9E5E3]">
                            <path
