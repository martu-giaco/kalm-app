<a href="{{ route('brands.show', $brand) }}" class="group block px-2">
    <div class="flex p-5 items-center justify-between gap-4 transition-shadow shadow-lg rounded-xl w-full bg-white dark:bg-[#306067]">
            ...
            <div class="flex-1 min-w-0">
                <div class="flex items-center justify-between gap-3">
                    <div class="flex w-full justify-between items-end">
                        <h2 class="text-lg font-semibold text-[#2A4043] dark:text-[#CCE2E5] truncate">{{ $brand->name }}</h2>
                    </div>
                </div>
        ...
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" class="fill-[#2A4043] dark:fill-[#CCE2E5]"><path d="M579-480 285-774q-15-15-14.5-35.5T286-845q15-15 35.5-15t35.5 15l307 308q12 12 18 27t6 30q0 15-6 30t-18 27L356-115q-15 15-35 14.5T286-116q-15-15-15-35.5t15-35.5l293-293Z"/></svg>
        </div>
    </div>
</a>
