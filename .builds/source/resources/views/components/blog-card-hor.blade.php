...
<a
    ...
    @endif
                    class="relative flex-shrink-0 mb-4 flex overflow-hidden transition-transform transform bg-white dark:bg-[#306067] shadow-lg w-full rounded-2xl hover:shadow-2xl">
                    <div>
                        {{-- icono de bookmark --}}
                    ...
                    <div class="flex flex-col p-4 relative">
                        ...
                        <p class="mt-2 text-sm text-[#306067] dark:text-[#CCE2E5] line-clamp-3 {{ ($blog->canView ?? true) ? '' : 'blur-sm' }}">
                            {{ $blog->description }}
                        </p>
