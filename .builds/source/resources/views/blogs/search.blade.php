        ...
        <div class="mb-[-3vw] relative">
            <form id="search-form" action="{{ route('blog.search') }}" method="GET" class="relative">
                ...
                <button id="search-clear" type="button" aria-label="Limpiar búsqueda"
                    class="absolute -translate-y-1/2 right-3 top-1/2 p-2 text-[#306067] dark:text-[#E9E5E3] {{ request('q') ? '' : 'hidden' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                        class="fill-[#306067] dark:fill-[#CCE2E5]">
                        <path
                    ...
                    <div class="p-0 modal-box">
                        ...
                        <form action="{{ route('blog.search') }}" method="GET">
                            ...
                            <section class="max-h-[60vh] overflow-y-auto">
                                <div class="mb-6">
                                    <h3 class="text-lg mb-5 p-4 border-y text-[#2A4043] dark:text-[#CCE2E5] font-semibold">
                                        Categoría
                                    </h3>
                                    ...
                                    <div class="grid grid-cols-2 gap-3 mx-4">
                                        @foreach ($tags as $tag)
                                            <label class="cursor-pointer">
                                                ...
                                                <div class="py-2 text-center rounded-xl border border-[#CCE2E5] dark:border-[#CCE2E5]
                            ...
                            <div class="mt-6 p-4 border-t-[1px] border-t-[#CCE2E5] dark:border-t-[#CCE2E5]">
                                <button type="submit"
