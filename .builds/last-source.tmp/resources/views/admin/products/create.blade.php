    ...
    <div class="container my-5 px-5 bg-white rounded-t-3xl min-h-full pt-5">
        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" id="name" class="w-full p-3 mb-3 bg-transparent rounded-xl border-2 border-[#CCE2E5] placeholder-[#CCE2E5] focus:outline-[#37A0AF] text-md text-[#2A4043]" placeholder="Nombre">
            </div>
            ...
            <div class="mt-3 mb-3">
                ...
                <textarea name="description" id="description" class="w-full p-3 mb-3 bg-transparent rounded-xl border-2 border-[#CCE2E5] placeholder-[#CCE2E5] focus:outline-[#37A0AF] text-md text-[#2A4043]" placeholder="Descripción"></textarea>
            </div>

            <div class="mt-3 mb-3">
                <label for="ingredientes" class="block mb-1 text-sm">Ingredientes</label>
                <textarea name="ingredientes" id="ingredientes" class="w-full p-3 mb-3 bg-transparent rounded-xl border-2 border-[#CCE2E5] placeholder-[#CCE2E5] focus:outline-[#37A0AF] text-md text-[#2A4043]" placeholder="Ingredientes"></textarea>
            </div>

            <div class="mt-3 mb-3">
                <label for="activos" class="block mb-1 text-sm">Activos</label>
                <textarea name="activos" id="activos" class="w-full p-3 mb-3 bg-transparent rounded-xl border-2 border-[#CCE2E5] placeholder-[#CCE2E5] focus:outline-[#37A0AF] text-md text-[#2A4043]" placeholder="Activos"></textarea>
            </div>

            <div class="mt-3 mb-3">
                <label for="formato" class="block mb-1 text-sm">Formato</label>
                <input name="formato" id="formato" class="w-full p-3 mb-3 bg-transparent rounded-xl border-2 border-[#CCE2E5] placeholder-[#CCE2E5] focus:outline-[#37A0AF] text-md text-[#2A4043]" placeholder="Formato">
            </div>
