<x-layout title="Sobre Kälm">
    <section class="px-5 py-10 rounded-t-3xl bg-white">
        <h1 class="text-2xl font-semibold text-[#306067] mb-3">Términos y Condiciones</h1>
        <div class="mb-10">
            <h2 class="text-[#306067]">1. Introducción</h2>
                    <p class="text-sm">
                        Estos Términos y Condiciones regulan el acceso y uso de la aplicación Kälm, sus funcionalidades de asesoramiento de skincare, haircare y
                    ...
                    <p class="mt-10 text-sm">
                        Si tiene dudas sobre estos Términos o desea más información sobre nuestro tratamiento de datos, contáctenos a través de los canales oficiales que figuran en la Plataforma.
                    </p>
        </div>
    </section>
</x-layout>
