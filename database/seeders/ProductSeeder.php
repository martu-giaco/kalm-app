    ...
    public function run(): void
    {
        ...
        $typesCategories = [
            'Skincare' => [
                ...
                'Protectores Solares' => [
                    'description' => 'Productos diseñados para proteger la piel de los daños causados por la radiación UV, previniendo el envejecimiento prematuro y el cáncer de piel.',
                    'products' => [
                        [
                ...
                'Sérums' => [
                    'description' => 'Productos de alta concentración de ingredientes activos diseñados para tratar preocupaciones específicas de la piel.',
                    'products' => [
                        [
                        ...
                        [
                            ...
                            'ingredients' => 'Aqua/Water, Sodium Ascorbate (And) Hydrolyzed Collagen (And) Lecithin (And) Cholesterol (And) Tocopherol Acetate, Glycerin, Propanediol, Centella Asiatica Extract, Phenoxyethanol, Panthenol, Cucumis Sativus Extract, Ferulic Acid, Xanthan Gum, Tremella Fuciformis (Mushroom) Extract, Triethanolamine, Lavandula Angustifolia Flower Oil.',
                ...
                'Exfoliantes' => [
                    'description' => 'Diseñados para eliminar las células muertas de la superficie de la piel, promoviendo la renovación celular y mejorando la textura y luminosidad.',
                    'products' => [
                        [
            ...
            'Haircare' => [
                'Shampoo' => [
                    'description' => 'Diseñado para limpiar el cuero cabelludo y el cabello, eliminando el exceso de sebo, suciedad ambiental, células muertas y residuos de productos capilares',
                    'products' => [
                        [
                ...
                'Acondicionador' => [
                    'description' => 'Formulados para hidratar, desenredar y suavizar el cabello después del shampoo, mejorando su manejabilidad y apariencia.',
                    'products' => [
                        [
                ...
                'Tratamientos' => [
                    'description' => 'Productos diseñados para mejorar la salud, nutrición, fuerza y apariencia del cabello y cuero cabelludo. Sus principales utilidades incluyen detener la caída, estimular el crecimiento, hidratar en profundidad, reparar el daño estructural, reducir el frizz, controlar la grasa y combatir la caspa.',
                    'products' => [
                        [
            ...
            'Bodycare' => [
                'Hidratantes Corporales' => [
                    'description' => 'Productos formulados para hidratar la piel del cuerpo, restaurar la barrera cutánea y mantener la humectación.',
                    'products' => [
                        [
