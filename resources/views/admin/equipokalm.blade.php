<x-layout  title="Equipo Kälm">
    <section class="px-5 pt-10 h-full rounded-t-3xl bg-white">
        <div class="flex items-center mb-3">
            <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#306067" class="p-0">
            ...
            <h1 class="text-2xl font-semibold text-[#306067] ms-3">Equipo Kälm</h1>
        </div>
        <p class="mb-5">Conocé a los administradores que hacen posible el funcionamiento de Kälm.</p>
