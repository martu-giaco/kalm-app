    ...
    <div class="p-6 mx-auto mt-20 bg-white shadow pt-9 rounded-t-3xl">
            ...
            <div class="mb-6">
                <div class="rounded overflow-auto prose text-md md:text-lg lg:text-xl leading-relaxed">
                    ...
                    <p class="mt-10 text-sm md:text-md lg:text-lg">
            ...
            <form action="{{ route('auth.terms.accept') }}" method="POST" id="termsForm">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <label for="termsCheck" class="inline-flex items-center gap-3">
                        ...
                        <span class="btn-primary inline-block px-4 py-2 text-sm md:text-md lg:text-lg font-bold select-none text-[#2A4043]">
                    ...
                    <div class="flex items-center w-full">
                        <button
                            id="acceptBtn"
                            type="submit"
                            class=" hover:bg-[#306067] bg-[#306067] btn w-full inline-flex text-white border-none disabled:bg-[#CCE2E5] disabled:text-gray-600 px-6 py-3 rounded-xl font-bold transition-all duration-300 text-sm md:text-md lg:text-lg items-center justify-center gap-2 cursor-not-allowed"
                            disabled
                        >
                            Crear Cuenta
                        </button>
