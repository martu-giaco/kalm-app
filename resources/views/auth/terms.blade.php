...
<body class="flex items-end bg-center bg-cover min-h-screen header-bg">
    <div class="p-6 mx-auto mt-20 bg-white shadow pt-9 rounded-t-3xl dark:bg-[#2A4043]">
            <h1 class="text-[#306067] text-2xl font-semibold mb-4 dark:text-[#CCE2E5]">Términos y Condiciones</h1>
            {{-- CONTENIDO DE TÉRMINOS: solo este bloque es scrollable --}}
            <div class="mb-6">
                <div class="rounded overflow-auto prose text-md md:text-lg lg:text-xl leading-relaxed">
                    <h2 class="text-[#306067] dark:text-[#CCE2E5]">1. Introducción</h2>
                    <p class="text-sm md:text-md lg:text-lg dark:text-[#E9E5E3]">
                    ...
                    <h2 class="text-[#306067] dark:text-[#CCE2E5] mt-5">2. Naturaleza del asesoramiento</h2>
                    <p class="text-sm md:text-md lg:text-lg dark:text-[#E9E5E3]">
                    ...
                    <h2 class="text-[#306067] dark:text-[#CCE2E5] mt-5">3. Teleconsulta y servicios profesionales</h2>
                    <p class="text-sm md:text-md lg:text-lg dark:text-[#E9E5E3]">
                    ...
                    <h2 class="text-[#306067] dark:text-[#CCE2E5] mt-5">4. Responsabilidad y limitación</h2>
                    <p class="text-sm md:text-md lg:text-lg dark:text-[#E9E5E3]">
                    ...
                    <h2 class="text-[#306067] dark:text-[#CCE2E5] mt-5">5. Productos y recomendaciones</h2>
                    <p class="text-sm md:text-md lg:text-lg dark:text-[#E9E5E3]">
                    ...
                    <h2 class="text-[#306067] dark:text-[#CCE2E5] mt-5">6. Consentimiento para uso de imágenes y datos</h2>
                    <p class="text-sm md:text-md lg:text-lg dark:text-[#E9E5E3]">
                    ...
                    <h2 class="text-[#306067] dark:text-[#CCE2E5] mt-5">7. Privacidad y tratamiento de datos</h2>
                    <p class="text-sm md:text-md lg:text-lg dark:text-[#E9E5E3]">
                    ...
                    <h2 class="text-[#306067] dark:text-[#CCE2E5] mt-5">8. Contenido del usuario y conducta</h2>
                    <p class="text-sm md:text-md lg:text-lg dark:text-[#E9E5E3]">
                    ...
                    <h2 class="text-[#306067] dark:text-[#CCE2E5] mt-5">9. Propiedad intelectual</h2>
                    <p class="text-sm md:text-md lg:text-lg dark:text-[#E9E5E3]">
                    ...
                    <h2 class="text-[#306067] dark:text-[#CCE2E5] mt-5">10. Pagos y reembolsos</h2>
                    <p class="text-sm md:text-md lg:text-lg dark:text-[#E9E5E3]">
                    ...
                    <h2 class="text-[#306067] dark:text-[#CCE2E5] mt-5">11. Enlaces y servicios de terceros</h2>
                    <p class="text-sm md:text-md lg:text-lg dark:text-[#E9E5E3]">
                    ...
                    <h2 class="text-[#306067] dark:text-[#CCE2E5] mt-5">12. Modificaciones del servicio y de los Términos</h2>
                    <p class="text-sm md:text-md lg:text-lg dark:text-[#E9E5E3]">
                    ...
                    <h2 class="text-[#306067] dark:text-[#CCE2E5] mt-5">13. Edad mínima</h2>
                    <p class="text-sm md:text-md lg:text-lg dark:text-[#E9E5E3]">
                    ...
                    <h2 class="text-[#306067] dark:text-[#CCE2E5] mt-5">14. Indemnidad</h2>
                    <p class="text-sm md:text-md lg:text-lg dark:text-[#E9E5E3]">
                    ...
                    <h2 class="text-[#306067] dark:text-[#CCE2E5] mt-5">15. Ley aplicable y jurisdicción</h2>
                    <p class="text-sm md:text-md lg:text-lg dark:text-[#E9E5E3]">
                    ...
                    <p class="mt-10 text-sm md:text-md lg:text-lg dark:text-[#CCE2E5]">
            ...
            <form action="{{ route('auth.terms.accept') }}" method="POST" id="termsForm">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <label for="termsCheck" class="inline-flex items-center gap-3">
                        ...
                        <span class="btn-primary inline-block px-4 py-2 text-sm md:text-md lg:text-lg font-bold select-none text-[#2A4043] dark:text-[#E9E5E3]">
                    ...
                    <div class="flex items-center w-full">
                        <button
                            id="acceptBtn"
                            type="submit"
                            class=" hover:bg-[#306067] bg-[#306067] btn w-full inline-flex text-white border-none disabled:bg-[#CCE2E5] disabled:text-gray-600 px-6 py-3 rounded-xl font-bold transition-all duration-300 text-sm md:text-md lg:text-lg items-center justify-center gap-2 cursor-not-allowed dark:bg-[#CCE2E5] dark:text-[#2A4043] dark:disabled:bg-[#306067] dark:disabled:text-[#CCE2E5]"
                            disabled
                        >
                            Crear Cuenta
                        </button>
