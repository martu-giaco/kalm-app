...
<body class="min-h-screen text-center flex flex-col justify-end mx-auto bg-[#2A4043] p-6">
    ...
    <h1 class="text-white text-2xl font-semibold">El pago está pendiente</h1>
    <p class="text-[#CCE2E5] text-md mt-2 mb-20 pb-20">Estamos procesando tu pago. Te notificaremos una vez esté completado.</p>
