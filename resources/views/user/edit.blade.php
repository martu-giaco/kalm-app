...
<x-layout :title="'Editar perfil'">
    <section class="w-full px-2 pb-20 bg-white dark:bg-[#2A4043] h-vh pt-7 rounded-t-3xl">
     ...
     class="object-cover w-10 h-10 rounded-full">
                        ...
                        <div class="w-full ms-2">
                            <p class="mb-1 text-sm text-[#306067] dark:text-[#CCE2E5]">Foto de perfil</p>
                            <label for="avatar"
                                class="flex justify-between mb-1 text-md p-3 bg-transparent rounded-xl border-2 border-[#2A4043] dark:border-[#CCE2E5] placeholder-[#CCE2E5] focus:outline-[#2A4043] text-[#2A4043]">
                                <p class="text-[#306067] dark:text-[#CCE2E5]">Subir una foto</p>
                    ...
                    <div class="mb-4">
                        <label for="name" class="block mb-1 text-sm text-[#306067] dark:text-[#CCE2E5]">Nombre</label>
                        <input id="name" type="text" name="name" value="{{ old('name', $user->name) }}"
                            class="w-full p-3 bg-transparent rounded-xl border-2 border-[#37A0AF] dark:border-[#CCE2E5] placeholder-[#CCE2E5] focus:outline-[#37A0AF] text-md text-[#2A4043] dark:text-[#CCE2E5]"
                            required>
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="email" class="block mb-1 text-sm text-[#306067] dark:text-[#CCE2E5]">Email</label>
                ...
                <div class="gap-3 mt-7">
                    <button type="submit"
                        class="btn border-none w-full mb-2 px-5 py-3 rounded-xl text-white font-bold transition cursor-pointer disabled:opacity-80 disabled:cursor-not-allowed hover:bg-[#306067] bg-[#306067]">Guardar
                        cambios</button>
                    <a href="{{ route('profile.show') }}"
                        class="mt-1 btn w-full inline-flex border-2 border-[#306067] text-[#306067] dark:border-[#E9E5E3] dark:text-[#E9E5E3] bg-transparent px-6 py-3 rounded-xl font-semiboldbold transition-all duration-300 items-center justify-center gap-2 text-sm font-bold">Cancelar</a>
                </div>
            </form>
        </div>
    </section>
