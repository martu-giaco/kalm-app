...
<body class="min-h-screen text-center flex flex-col justify-end mx-auto bg-[#2A4043] p-6">
    ...
    <img class="mx-auto" src="{{ asset('images/icons/check_circle.svg') }}" alt="success icon">
    <h1 class="text-white text-3xl font-semibold">¡Listo!</h1>
    <p class="text-[#CCE2E5] mt-2 mb-20 pb-20">Ya podés disfrutar de todos los beneficios de Kälm Premium</p>
