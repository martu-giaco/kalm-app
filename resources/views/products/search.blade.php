    ...
    <section class=" bg-[var(--kalm-bg)]">
        ...
        <div class="px-5">
            <form action="{{ route('products.search') }}" method="GET" class="relative max-w-3xl mx-auto">
                ...
                <input id="q" type="text" name="q" value="{{ request('q', $query ?? '') }}"
                    placeholder="Buscar productos, marcas o ingredientes" class="w-full pl-11 pr-4 py-3 rounded-xl shadow-xl bg-white border border-[#CCE2E5] text-[#306067] placeholder-[#CCE2E5]
        ...
        <div class="pb-6 pt-7 px-5 rounded-t-3xl bg-white mt-6">
            ...
            <div class="flex items-start justify-between gap-4">
                <div class="flex-1">
                    ...
                    <p class="text-sm text-[var(--kalm-text)]">
                        ...
                        resultado{{ ($products->total() ?? $products->count()) > 1 ? 's' : '' }}
                    </p>
                </div>
                ...
                <div>
                    <a href="{{ route('products.index') }}"
                        class="inline-flex items-center gap-2 text-sm text-[#306067] hover:underline">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 -960 960 960" fill="#306067">
                            <path
                                d="M710-150q-63 0-106.5-43.5T560-300q0-63 43.5-106.5T710-450q63 0 106.5 43.5T860-300q0 63-43.5 106.5T710-150Zm0-80q29 0 49.5-20.5T780-300q0-29-20.5-49.5T710-370q-29 0-49.5 20.5T640-300q0 29 20.5 49.5T710-230ZM250-510q-63 0-106.5-43.5T100-660q0-63 43.5-106.5T250-810q63 0 106.5 43.5T400-660q0 63-43.5 106.5T250-510Z" />
                        </svg>
                        Volver a productos
                    </a>
                </div>
            ...
            <div class="mt-5">
                ...
                @else
                    ...
                    <div class="max-h-[45vh] overflow-y-auto space-y-4">
                        @foreach($products as $product)
                            <a href="{{ route('products.show', $product) }}" class="group block">
                                <div
                                    class="flex items-center gap-4 p-3 rounded-lg border border-gray-100 hover:shadow-md transition-shadow bg-white">
                                    {{-- Imagen redonda --}}
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="mt-1 text-xs text-[var(--kalm-text)] flex flex-wrap gap-2">
                                            <span class="truncate"><strong>Marca:</strong>
                                                {{ $product->brand->name ?? '-' }}</span>
                                            <span class="truncate"><strong>Tipo:</strong>
                                                {{ $product->type->name ?? '-' }}</span>
                                            <span class="truncate"><strong>Categoría:</strong>
