                            ...
                            <div>
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center">
                                            <h2 class="text-xl font-medium text-[#306067]">{{ $routine->name }}</h2>
                                    ...
                                    <p class="text-[#37A0AF] text-sm text-start">{{ $routine->types->pluck('name')->join(', ') ?: 'No definido' }} · {{ $routine->routineTime?->name ?? 'No definido' }}</p>
                                </div>
