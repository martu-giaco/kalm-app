    ...
    @auth
        <script>
            ...
            function checkRoutineReminders() {
                ...
                userReminders.forEach(routine => {
                    if (routine.formatted_time === currentTime && !sentNotifications.has(routine.routine_id)) {

                        sentNotifications.add(routine.routine_id);

                        Push.create('¡Es hora de tu rutina! ✨', {
                            body: `Hacé clic acá para registrar tu rutina: "${routine.name}"`,
                            icon: "{{ asset('images/pfp.svg') }}",
                            timeout: 15000,
                            vibrate: [100, 100, 100],
                            onClick: function() {
                    ...
                    <section class="flex flex-col flex-wrap h-full mt-5 space-between">
                        <div class="mb-10">
                            ...
                            <p class="text-3xl font-bolder"
                                style="font-family: 'Tropiline LogoOnly'; color: #37A0AF; background-image: linear-gradient(45deg, #37A0AF , #CCE2E5 88%); background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
                                Kälm Premium</p>
                            <div>
                                <div class="w-full mt-7 collapse collapse-arrow bg-base-100 bg-[#306067]">
                                    ...
                                    <div class="flex items-center font-bold text-white collapse-title">
                                        <img src="{{ asset('images/icons/assignment.svg') }}" alt="rutinas"
                                            class="w-auto h-5 mr-2" />
                                        <p class="text-white">Rutinas personalizables ilimitadas</p>
                                    </div>
                                    <div class="collapse-content">
                                        <p class="text-sm text-[#CCE2E5]">Renová tus rutinas sin perder tu historia
                                            activando y desactivando rutinas según tu actividad.</p>
                                    </div>
                                </div>
                                ...
                                <div class="w-full mt-2 collapse collapse-arrow bg-base-100 bg-[#306067]">
                                    ...
                                    <div class="flex items-center font-bold text-white collapse-title">
                                        <img src="{{ asset('images/icons/add_circle.svg') }}" alt="rutinas"
                                            class="w-auto h-5 mr-2" />
                                        <p class="text-white">Productos ilimitados en rutinas</p>
                                    </div>
                                    <div class="collapse-content">
                                        <p class="text-sm text-[#CCE2E5]">Ahora podés agregar +20 productos a tus
                                            rutinas.</p>
                                    </div>
                                </div>
                                ...
                                <div class="w-full mt-2 collapse collapse-arrow bg-base-100 bg-[#306067]">
                                    <input type="radio" name="premium-perks" />
                                    <div class="flex items-center font-bold text-white collapse-title">
                                        <img src="{{ asset('images/icons/experiment.svg') }}" alt="rutinas"
                                            class="w-auto h-5 mr-2" />
                                        <p class="text-white">Diagnóstico a fondo de piel y cabello</p>
                                    </div>
                                    <div class="collapse-content">
                                        <p class="text-sm text-[#CCE2E5]">Disfrutá de tests extra y descubrí aún más
                                            sobre tu piel y cabello.</p>
                                    </div>
                                </div>
                                ...
                                <div class="w-full mt-2 collapse collapse-arrow bg-base-100 bg-[#306067]">
                                    <input type="radio" name="premium-perks" />
                                    <div class="flex items-center font-bold text-white collapse-title">
                                        <img src="{{ asset('images/icons/news.svg') }}" alt="rutinas"
                                            class="w-auto h-5 mr-2" />
                                        <p class="text-white">Artículos escritos por profesionales</p>
                                    </div>
                                    <div class="collapse-content">
                                        <p class="text-sm text-[#CCE2E5]">Accedé a cientos de articulos escritos por
                                            dermatólogos expertos con tips, explicaciones simples e información
                                            actualizada.</p>
                                    </div>
                                </div>
                                ...
                                <div class="w-full mt-2 collapse collapse-arrow bg-base-100 bg-[#306067]">
                                    <input type="radio" name="premium-perks" />
                                    <div class="flex items-center font-bold text-white collapse-title">
                                        <img src="{{ asset('images/icons/mail.svg') }}" alt="rutinas"
                                            class="w-auto h-5 mr-2" />
                                        <p class="text-white">Self-pack de bienvenida*</p>
                                    </div>
                                    <div class="collapse-content">
                                        <p class="text-sm text-[#CCE2E5]">Recibí un pack de bienvenida con productos
                                            exclusivos para nuevos suscriptores.(*solo aplica para usuarios residentes
                                            de Argentina)</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mt-15">
                            <a href="{{ route('subscription.show') }}"
                                class="btn text-md w-full px-5 mb-2 py-3 border-0 rounded-xl text-[#2A4043] dark:text-[#E9E5E3] font-bold transition cursor-pointer hover:bg-[#306067] disabled:opacity-80 disabled:cursor-not-allowed bg-[#306067]"
                                style="background-image: linear-gradient(45deg, #37A0AF , #CCE2E5 88%);">
                                Suscribirme por $7,000/mes
                            </a>
                            <button type="button" onclick="premium_modal.close()"
                            ...
                            <p class="text-[#CCE2E5] text-xs text-center mt-3">Esta subscripción se puede cancelar en
                                cualquier momento.</p>
                        </div>
                    </section>
                </div>
                            ...
                            @if (auth()->user()?->role !== 'admin')
                                ...
                                <li class="flex flex-col items-center font-bold">
                                    <a href="{{ route('home') }}" class="flex flex-col items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="35px" viewBox="0 -960 960 960"
                                            width="35px"
                                            class="{{ request()->routeIs('home') ? 'fill-[#37A0AF]' : 'fill-[#306067] dark:fill-[#E9E5E3]' }}">
                                            <path
                                ...
                                <li class="flex flex-col items-center font-bold">
                                    <a href="{{ route('products.search') }}" class="flex flex-col items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="35px" viewBox="0 -960 960 960"
                                            width="35px"
                                            class="{{ request()->routeIs('products.search*') ? 'fill-[#37A0AF]' : 'fill-[#306067] dark:fill-[#E9E5E3]' }}">
                                            <path
                                ...
                                <li class="flex flex-col items-center font-bold">
                                    <a href="{{ route('blog.index') }}" class="flex flex-col items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="35px" viewBox="0 -960 960 960"
                                            width="35px"
                                            class="{{ request()->routeIs('blog.*') ? 'fill-[#37A0AF]' : 'fill-[#306067] dark:fill-[#E9E5E3]' }}">
                                            <path
                                ...
                                <li class="flex flex-col items-center font-bold">
                                    <a href="{{ route('profile.show') }}" class="flex flex-col items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="35px" viewBox="0 -960 960 960"
                                            width="35px"
                                            class="{{ request()->routeIs('profile.*') ? 'fill-[#37A0AF]' : 'fill-[#306067] dark:fill-[#E9E5E3]' }}">
                                            <path
                            ...
                            @else
                                ...
                                <li class="flex flex-col items-center font-bold">
                                    <a href="{{ route('admin.home') }}" class="flex flex-col items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="35px" viewBox="0 -960 960 960"
                                            width="35px"
                                            class="{{ request()->routeIs('admin.home') ? 'fill-[#37A0AF]' : 'fill-[#306067] dark:fill-[#E9E5E3]' }}">
                                            <path
                                                d="M151.87-202.87v-355.7q0-21.63 9.58-40.9 9.57-19.27 26.72-31.94L425.3-809.26q24.11-18.39 54.7-18.39 30.59 0 54.7 18.39l237.13 177.85q17.15 12.67 26.72 31.94 9.58 19.27 9.58 40.9v355.7q0 37.78-26.61 64.39t-64.39 26.61H607.41q-19.15 0-32.32-13.17-13.18-13.18-13.18-32.33v-199.04q0-19.16-13.17-32.33-13.17-13.17-32.33-13.17h-72.82q-19.16 0-32.33 13.17-13.17 13.17-13.17 32.33v199.04q0 19.15-13.18 32.33-13.17 13.17-32.32 13.17H242.87q-37.78 0-64.39-26.61t-26.61-64.39Z" />
                                        </svg>
                                        <span class="sr-only">Inicio</span>
                                ...
                                <li class="flex flex-col items-center font-bold">
                                    <a href="{{ route('admin.users.index') }}" class="flex flex-col items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="35px" viewBox="0 -960 960 960"
                                            width="35px"
                                            class="{{ request()->routeIs('admin.users.*') ? 'fill-[#37A0AF]' : 'fill-[#306067] dark:fill-[#E9E5E3]' }}">
                                            <path
                                                d="M480-480q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47ZM160-240v-32q0-34 17.5-62.5T224-378q62-31 126-46.5T480-440q66 0 130 15.5T736-378q29 15 46.5 43.5T800-272v32q0 33-23.5 56.5T720-160H240q-33 0-56.5-23.5T160-240Z" />
                                        </svg>
                                ...
                                <li class="flex flex-col items-center font-bold">
                                    <a href="{{ route('admin.products.index') }}" class="flex flex-col items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="34px" viewBox="0 -960 960 960"
                                            width="34px"
                                            class="{{ request()->routeIs('admin.products.*') ? 'fill-[#37A0AF]' : 'fill-[#306067] dark:fill-[#E9E5E3]' }}">
                                            <path
                                ...
                                <li class="flex flex-col items-center font-bold">
                                    <a href="{{ route('admin.blog.index') }}" class="flex flex-col items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="35px" viewBox="0 -960 960 960"
                                            width="35px"
                                            class="{{ request()->routeIs('admin.blog.*') ? 'fill-[#37A0AF]' : 'fill-[#306067] dark:fill-[#E9E5E3]' }}">
                                            <path
                                                d="M202.87-111.87q-37.78 0-64.39-26.61t-26.61-64.39v-554.26q0-37.78 26.61-64.39t64.39-26.61h399.59q18.15 0 34.68 6.84 16.53 6.83 29.21 19.51l155.43 155.43q12.68 12.68 19.51 29.21 6.84 16.53 6.84 34.68v399.59q0 37.78-26.61 64.39t-64.39 26.61H202.87ZM593.3-757.13v118.33q0 19.15 13.18 32.32 13.17 13.18 32.32 13.18h118.33L593.3-757.13Zm48.61 475.22q17.24 0 28.98-11.86 11.74-11.86 11.74-29.1 0-17.24-11.74-28.98-11.74-11.74-28.98-11.74H318.09q-17.24 0-28.98 11.74-11.74 11.74-11.74 28.98 0 17.24 11.86 29.1 11.86 11.86 29.1 11.86h323.58ZM446.46-594.5q17.24 0 29.09-11.86 11.86-11.86 11.86-29.1 0-17.24-11.86-29.09-11.85-11.86-29.09-11.86H318.33q-17.24 0-29.1 11.86-11.86 11.85-11.86 29.09 0 17.24 11.86 29.1 11.86 11.86 29.1 11.86h128.13Zm195.21 156.41q17.24 0 29.1-11.86 11.86-11.85 11.86-29.09 0-17.24-11.86-29.1Q658.91-520 641.67-520H318.33q-17.24 0-29.1 11.86-11.86 11.86-11.86 29.1 0 17.24 11.86 29.09 11.86 11.86 29.1 11.86h323.34Z" />
                                        </svg>
                                        <span class="sr-only">Blog</span>
                                ...
                                <li class="flex flex-col items-center font-bold">
                                    <a href="{{ route('admin.brands.index') }}" class="flex flex-col items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="35px" viewBox="0 -960 960 960"
                                            width="35px"
                                            class="{{ request()->routeIs('admin.brands.*') ? 'fill-[#37A0AF]' : 'fill-[#306067] dark:fill-[#E9E5E3]' }}">
                                            <path
                            ...
                            <div class="flex justify-between">
                                @if (auth()->user()->role === 'free')
                                    <div onclick="premium_modal.showModal()"
                                        class="py-1 px-3 rounded-xl bg-[#CCE2E5] text-[#306067] cursor-pointer">
                            ...
                            <li>
                                <a class="flex flex-row text-lg text-[#2A4043] dark:text-[#E9E5E3] w-full justify-between items-center hover:bg-transparent"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960"
                                        width="24px" class="fill-[#306067] dark:fill-[#E9E5E3]">
                                        <path
                                            d="M480-480q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47ZM160-240v-32q0-34 17.5-62.5T224-378q62-31 126-46.5T480-440q66 0 130 15.5T736-378q29 15 46.5 43.5T800-272v32q0 33-23.5 56.5T720-160H240q-33 0-56.5-23.5T160-240Z" />
                                    </svg>
                                </a>
                        ...
                        <li>
                            <form action="{{ route('auth.logout') }}" method="POST" class="flex justify-between w-full">
                                ...
                                <button type="submit"
                                    ...
                                    Cerrar sesión
                                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960"
                                        width="24px" class="ml-2 fill-[#741919] dark:fill-[#E9E5E3]">
                                        <path
