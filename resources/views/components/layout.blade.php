...
<body class="d-flex flex-column min-vh-100 bg-light">
    ...
    <div class="hidden flex items-center ml-5">
        <img src="{{ asset('images/logo-kalm.svg') }}" alt="Logo Kälm" class="h-10">
        <p class="logo-text text-lg pt-1 ms-1">Kälm</p>
    </div>

        <div class="flex flex-1 items-center space-x-6 justify-evenly justify-center space-x-8">
            <ul class="navbar-nav fw-semibold d-flex align-items-center">
                @if(auth()->check() && auth()->user()->role === 'user')
                    <li class="flex flex-col md:flex-row items-center font-bold text-(--kälm-dark)">
                        ...
                        <a class="hidden" href="{{ route('home') }}">Inicio</a>
                    </li>
                    <li class="flex flex-col md:flex-row items-center font-bold text-(--kälm-dark)">
                        ...
                        <a class="hidden" href="{{ route('') }}">busqueda</a>
                    </li>
                    <li class="flex flex-col md:flex-row items-center font-bold text-(--kälm-dark)">
                        ...
                        <a class="hidden" href="{{ route('') }}">Crear post</a>
                    </li>
                    <li class="flex flex-col md:flex-row items-center font-bold text-(--kälm-dark)">
                        ...
                        <a class="hidden" href="{{ route('') }}">Comunidad</a>
                    </li>
                    <li class="flex flex-col md:flex-row items-center font-bold text-(--kälm-dark)">
                        ...
                        <a class="hidden" href="{{ route('') }}">Blog</a>
                    </li>
                @endif
                @if(auth()->check() && auth()->user()->role === 'admin')
                    <li class="flex flex-col md:flex-row items-center font-bold text-(--kälm-dark)">
                        <a class="hidden" href="{{ route('') }}">Usuarios</a>
                    </li>
                @endif
            </ul>
        </div>
