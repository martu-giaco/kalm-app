...
<body class="bg-light">
    ...
    <div class="drawer drawer-end">
        ...
        <div class="grid h-screen grid-cols-1 grid-rows-3 header-bg drawer-content">
            @if (!($hideNavigation ?? false))
                ...
                href="{{ route('admin.home') }}" @endif>
                    ...
                    @auth
                        ...
                        @else
                        href="{{ route('admin.home') }}" @endif>
                                <img src="{{ asset('images/notificaciones.png') }}" alt="notificaciones"
                                    class="w-auto h-7">
                            </a>
                    ...
                    <section class="flex flex-col flex-wrap h-full mt-5 space-between">
                        ...
                        <div class="mt-15">
                            <a href="{{ route('subscription.show') }}"
                                class="btn text-md w-full px-5 mb-2 py-3 border-0 rounded-xl text-[#2A4043] font-bold transition cursor-pointer hover:bg-[#306067] disabled:opacity-80 disabled:cursor-not-allowed bg-[#306067]"
            ...
            @if (!($hideNavigation ?? false))
                @auth
                    <nav class="fixed bottom-0 z-50 flex items-center justify-between w-full h-20 max-w-3xl px-5 transition-all duration-500 ease-in-out -translate-x-1/2 bg-white shadow-md left-1/2 rounded-t-3xl"
