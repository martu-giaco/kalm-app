                        ...
                        <article  onclick="window.location='{{ route('routines.show', $rutina) }}'" class="flex flex-col w-full px-3 py-5 mb-3 transition-shadow bg-white rounded-lg shadow-md cursor-pointer hover:shadow-lg">
                                <div>
                                    ...
                                    <span class="text-[#37A0AF] text-sm">{{ $rutina->routineType?->name ?? 'No definido' }} · {{ $rutina->routineNeed?->name ?? 'No definido' }}</span>
                                </div>
                        ...
                        <dialog id="menu_rutina_{{ $rutina->id }}" class="modal modal-bottom">
                                        <div class="modal-box">
                                            <a href="{{ route('routines.edit', $rutina) }}" class=" btn w-full inline-flex border-0 bg-[#CCE2E5] px-6 py-3 rounded-xl font-semiboldbold transition-all duration-300 items-center justify-between gap-2 text-sm font-bold">
                                                <p>Editar rutina</p>
