...
<a
    ...
    @endif
                    class="flex-shrink-0 mb-4 flex overflow-hidden transition-transform transform bg-white dark:bg-[#306067] shadow-lg w-full rounded-2xl hover:shadow-2xl">
                    <div>
                        {{-- Imagen --}}
                        @php
                            $img = $blog->image ?? null;
                    ...
                    <div class="flex flex-col p-4">
                        <div class="flex justify-between items-start">
                            <h3 class="text-xl wrap text-[#306067] dark:text-[#CCE2E5] mb-1">
                                {{ $blog->title }}
                            </h3>
