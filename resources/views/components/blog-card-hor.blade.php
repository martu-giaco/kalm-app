...
<a
    ...
    @endif
    class="flex mb-4 overflow-hidden transition-transform transform bg-white dark:bg-[#306067] shadow-lg w-full rounded-2xl hover:shadow-2xl items-stretch">
    ...
    <div class="flex flex-col justify-between p-4 flex-grow min-w-0">
        <div>
            <div class="flex justify-between items-start gap-2">
                <h3 class="text-xl wrap text-[#306067] dark:text-[#CCE2E5] mb-1 font-semibold">
                    {{ $blog->title }}
                </h3>
                ...
                <div class="flex justify-end flex-shrink-0">
                    <label class="cursor-pointer swap" onclick="event.stopPropagation()">
                        ...
                        <svg class="swap-off fill-[#facc15]" xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px">
                        ...
                        <svg class="swap-on fill-[#facc15]" xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px">
